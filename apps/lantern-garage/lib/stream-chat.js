...
// Shared, provider-agnostic helpers live in stream-chat/helpers.js so this
// orchestrator stays small and each concern is a focused, 200k-friendly file.
const {
  FALLBACK_DOORS,
  compactHistory,
